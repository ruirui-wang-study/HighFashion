export type SeoAutomationConnection = {
  connected: boolean;
...
export type SeoAutomationOverview = {
  ...
  searchConsole: SeoAutomationConnection;
  ga4: SeoAutomationConnection;
  opportunities: {
    total: number;
    new: number;
  };
...
export type SearchConsoleSyncRow = {
  page: string;
  query: string;
  country: string;
  device: string;
...
export type SearchConsoleSyncResult = {
  connection: SeoAutomationConnection;
  rows: SearchConsoleSyncRow[];
