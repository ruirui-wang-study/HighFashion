...
export const staticSeoPages = [
  ...
  },
  {
    ...
    description: "PulseGear brand entity profile for AI engines and customers.",
    canonical: "/pages/brand",
    indexStatus: "indexable" as const,
    hasAltText: true,
    hasStructuredData: false,
  },
  {
    url: "/pages/materials-and-fit-guide",
    title: "Materials and Fit Guide",
    description: "Materials, fit, and care principles for PulseGear products.",
    canonical: "/pages/materials-and-fit-guide",
    indexStatus: "indexable" as const,
    hasAltText: true,
    hasStructuredData: false,
  },
  {
    url: "/pages/shipping-returns-warranty",
    title: "Shipping Returns and Warranty",
    description: "Shipping, returns, and warranty policy for PulseGear.",
    canonical: "/pages/shipping-returns-warranty",
    indexStatus: "indexable" as const,
    hasAltText: true,
    hasStructuredData: false,
  },
