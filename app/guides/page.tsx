  ...
  return (
    <Section>
      <Container>
        ...
        <SectionHeader eyebrow="Guides" title="Practical buying context for support and carry gear" body="Browse running, training, support, hydration, and court buying guides with product and collection relationships." />
